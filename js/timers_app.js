...
var UIController = (function () {
  ...
  var kfcServiceTimes = {
    ...
    Total_DT_time: 150000, // Drive thru time in miliseconds = 150 (2 min 30 seconds) seconds
    ...
    Max_BK_target: 135000 // BUrger King time  max in miliseconds = 135 (2 min 15 seconds) seconds => new max time for Burger King
    };
  ...
  return {
    getNewCustomer: function (type) {
      ...
      // initializeClock: function(id,starttime){
      //   var clock = document.getElementById(id);
      //   var timeinterval = setInterval(function(){
      //     var t = timerController.getTimeRemaining(starttime);
      //     clock.innerHTML = t.minutes + ':' + t.seconds;
      //     console
      //     if(t.total === 30000){
      //       alert('My clocks is working. Hurraya!!!');
      //     } 
    ...
    addNewCustomerLine: function (obj, type) {
      ...
      if (type === 'kfc') {
        ...
        // <i class="fas fa-drumstick-bite"></i>  => icon of drumstick replaced by fried chicken meal img
        // <i class="fas fa-trash-alt"></i> => trash icon
        // <i class="fas fa-hand-holding-usd"></i> => money hand icon
        //fried chicken Icon made by <a href="https://www.flaticon.com/authors/freepik" title="Freepik">Freepik</a> from <a href="https://www.flaticon.com/" title="Flaticon"> www.flaticon.com</a>
        //trash bin Icon made by <a href="https://www.flaticon.com/authors/ddara" title="dDara">dDara</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div>
        //money Icon made by <a href="https://www.flaticon.com/authors/freepik" title="Freepik">Freepik</a> from <a href="https://www.flaticon.com/" title="Flaticon">www.flaticon.com</a></div>
        ...
        html = html + ' class="form-control timer description" placeholder="Customer description" id="kfc-description%id%"></div><div class="col-6"><div class="d-flex justify-content-between"><div class="col-2 text-center">';
        html = html + '<p class="form-control timer active" id="kfc-start__time%id%">%timeStart%</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc-paid__time%id%">Time paid</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc-stop__time%id%">Time stop</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc-otd__time%id%">OTD time</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc-total__time%id%">Total time</p></div></div ></div><div class="col-3 text-center"><div class="d-flex justify-content-around"><div class="editBox" id="kfc-paid-%id%"><img src="../img/money.png" class="food-img"/></div>';
        html = html + '<div class="editBox icon-disabled" id="kfc-stop-%id%"><img src="../img/fried-chicken-meal.png" class="food-img"/></div><div class="editBox" id="kfc-trash-%id%"><img src="../img/bin.png" class="food-img"/></div></div></div></div>';
      }
      ...
      if(type === 'kfc_DT') {
        ...
        elementID = obj.id; // to be able to start new stopwatch
        html = '<div class="row py-1 info-container times-container" id="kfc_DT-%id%"><div class="col-3 text-center align-content-center"><input type="text" class="form-control timer" placeholder="Car description" id="kfc_DT-description%id%"></div><div class="col-6"><div class="d-flex justify-content-between"><div class="col-2 text-center"><p class="form-control timer active" id="kfc_DT-start__time%id%">%timeStart%</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc_DT-paid__time%id%">Order time</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc_DT-stop__time%id%">Time stop</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc_DT-otd__time%id%">Window time</p></div><div class="col-2 text-center"><p class="form-control timer" id="kfc_DT-total__time%id%">Service time</p></div></div></div><div class="col-3 text-center"><div class="d-flex justify-content-around"><div class="editBox" id="kfc_DT-paid-%id%"><img src="../img/drive-thru.png" class="food-img"/></div><div class="editBox icon-disabled" id="kfc_DT-stop-%id%"><img src="../img/fried-chicken.png" class="food-img"/></div><div class="editBox" id="kfc_DT-trash-%id%"><img src="../img/bin.png" class="food-img"/></div></div></div></div></div>';
       }
